...
export const DEFAULT_RESOURCES_FILENAME = "RESOURCES.md";
...
export type WorkspaceBootstrapFileName =
  ...
  | typeof DEFAULT_RESOURCES_FILENAME;
...
export async function loadWorkspaceBootstrapFiles(dir: string): Promise<WorkspaceBootstrapFile[]> {
  ...
  const entries: Array<{
    ...
    {
      name: DEFAULT_RESOURCES_FILENAME,
      filePath: path.join(resolvedDir, DEFAULT_RESOURCES_FILENAME),
    },
  ];
