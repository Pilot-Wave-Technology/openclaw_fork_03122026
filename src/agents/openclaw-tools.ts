...
import { storyListTool, storyDetailTool, storyUpdateTool, storyCreateTool, storyModifyTool, storyCancelTool } from "./tools/story-tools.js";
...
export function createOpenClawTools(
  ...
  const tools: AnyAgentTool[] = [
    ...
    createMessageShcaTool({
      config: options?.config,
      agentSessionKey: options?.agentSessionKey,
    }),
    createResourceSummaryTool({
      config: options?.config,
      agentSessionKey: options?.agentSessionKey,
    }),
    createResourceScanTool({
      config: options?.config,
      agentSessionKey: options?.agentSessionKey,
    }),
  ...
  if (agentCfg?.dispatchMode === "shca") {
    tools.push(
      ...
      createAcpMemorySaveTool({ agentId }),
    );
  }
